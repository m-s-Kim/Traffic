...
import com.commerce.backend.entity.*;
...
public class AdvertisementService {
    ...
    public AdvertisementService(AdvertisementRepository advertisementRepository, RedisTemplate<String, Object> redisTemplate, AdViewHistoryRepository adViewHistoryRepository
                                , AdClickHistoryRepository adClickHistoryRepository, MongoTemplate mongoTemplate, AdViewStatRepository adViewStatRepository
                                , AdClickStatRepository adClickStatRepository) {
    ...
    public Optional<Advertisement> getAd(Long adId, String ip, Boolean isTrueView ) {
        this.insertAdViewHistory(adId, ip, isTrueView);
